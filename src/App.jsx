    ...
    <div className={darkMode ? "dark" : ""}>
        ...
        <section className="min-h-screen">
            <nav className="py-10 mb-12 flex justify-between">
              <div className='flex'>
              <p><CiUser className='text-2xl mx-2 text-teal-500' /></p>
              ...
              <ul className='flex item-center'>
                    ...
                    <li><a className='bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md ml-8 hover:opacity-80 ease-in-out duration-300' href="https://drive.google.com/file/d/1uDnyIqYKNKYwUJxsJeL_xyRFY7crhM0u/view?usp=sharing">Resume</a></li>
              </ul>
            </nav>
